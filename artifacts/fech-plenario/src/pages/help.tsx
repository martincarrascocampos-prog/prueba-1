...
const memberSteps: Step[] = [
  {
    icon: LogIn,
    title: "Inicia sesión",
    desc: "Entra con tu usuario y contraseña. La contraseña inicial es 1234; cámbiala apenas puedas desde “Ajustes”.",
  },
  {
    icon: UserCheck,
...
const adminSteps: Step[] = [
  ...
  },
  {
    ...
    desc: "En “Miembres” puedes ver la contraseña actual de cada cuenta (ícono del ojo) y restablecerla con el botón “Contraseña”. La lista se actualiza sola.",
  },
  {
    icon: Users,
